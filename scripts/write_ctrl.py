path = r"c:\Users\Elias\Documents\sistema_sivso_2026\app\Http\Controllers\DelegadosReporteController.php"
content = r"""<?php
...
{
    private function cx(): \Illuminate\Database\Connection
    {
