...
import { Search, Plus, Eye, Edit3, Trash2, ChevronDown, AlertTriangle, Users2 } from 'lucide-react';
...
export default function Index({ empleados = [] }) {
    ...
    const handleDelete = () => {
        if (itemToDelete) {
            destroy(route('empleados.destroy', itemToDelete.id), {
            ...
            <div className="mx-auto w-full max-w-[1600px] space-y-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
                    ...
                    <div className="w-full sm:w-48">
                        ...
                        <div className="relative">
                            <Users2 className="pointer-events-none absolute left-3.5 top-1/2 size-4 -translate-y-1/2 text-zinc-400" />
                            <select
                                value={statusFilter}
                        ...
                        <table className="w-full text-left min-w-[800px]">
                            <thead>
                                <tr className="border-b border-zinc-200 bg-zinc-50/50 dark:border-zinc-800 dark:bg-zinc-900/50">
                                    <th className="px-6 py-3 text-[10px] font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Empleado</th>
                                    <th className="px-6 py-3 text-[10px] font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Área / Puesto</th>
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                                                    ¿Estás seguro de que deseas eliminar a <span className="font-bold text-zinc-700 dark:text-zinc-300">{itemToDelete.nombre}</span>? Esta acción no se puede deshacer y todos sus datos serán eliminados permanentemente del sistema.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
