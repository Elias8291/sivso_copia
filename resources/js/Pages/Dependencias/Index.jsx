...
import { Search, Plus, Eye, Edit3, Trash2, ChevronDown, AlertTriangle, Building2 } from 'lucide-react';
...
export default function Index({ dependencias = [] }) {
    ...
    const handleDelete = () => {
        if (itemToDelete) {
            destroy(route('dependencias.destroy', itemToDelete.id), {
    ...
    }, [dependencias, search, statusFilter]);
            ...
            <div className="mx-auto w-full max-w-[1600px] space-y-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
                    ...
                    <div className="w-full sm:w-48">
                        ...
                        <div className="relative">
                            <Building2 className="pointer-events-none absolute left-3.5 top-1/2 size-4 -translate-y-1/2 text-zinc-400" />
                            <select
                                value={statusFilter}
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                                                    ¿Estás seguro de que deseas eliminar la dependencia <span className="font-bold text-zinc-700 dark:text-zinc-300">{itemToDelete.nombre}</span>? Esta acción no se puede deshacer.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
