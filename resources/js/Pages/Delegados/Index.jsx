...
import { Search, Plus, Eye, Edit3, Trash2, ChevronDown, AlertTriangle, User } from 'lucide-react';
...
export default function Index({ delegados = [] }) {
    ...
    const handleDelete = () => {
        if (itemToDelete) {
            destroy(route('delegados.destroy', itemToDelete.id), {
    ...
    const filtered = useMemo(() => {
        ...
        return result.filter(
            (u) =>
                ...
                u.delegacion?.toLowerCase().includes(q)
        );
    }, [delegados, search, statusFilter]);
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                            Gestión de los delegados del sistema.
                        </p>
                    </div>
                    ...
                    <div className="w-full sm:max-w-md">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="Nombre o delegación..."
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                                                    ¿Estás seguro de que deseas eliminar al delegado <span className="font-bold text-zinc-700 dark:text-zinc-300">{itemToDelete.nombre}</span>? Esta acción no se puede deshacer.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
